...
public class ApiRequest {
    ...
    private static Properties loadProperties() {
        ...
        try (InputStream input = ApiRequest.class.getClassLoader().getResourceAsStream("config.properties")) {
            if (input == null) {
    ...
    public void getRequest() {
        ...
        String getRequest = response.jsonPath().getString("id");
        System.out.println("New Resource ID: " + getRequest);
    }
